...
import tv from './assets/travel.jpg'
import t from './assets/tvl.jpg'
import tve from './assets/tv.jpg'
import {
  Text,
  View,
  SafeAreaView,
   ...
   <View>
    ...
    <View
     ...
     <Text style={{fontSize:"20px",fontWeight:"bold"}}>{e}</Text>
       ...
       <Text style={{fontSize:18,fontWeight:"bold"}}>No locations for this city!</Text>
